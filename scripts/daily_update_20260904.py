#!/usr/bin/env python3
"""Build the Beijing 2026-09-04 Google Play and Apple App Store snapshots."""
...
CAPTURE = "2026-09-04"
GOOGLE_DATE = "2026-09-04"
GOOGLE_BASELINE = "2026-06-06"
IOS_DATE = "2026-09-04"
IOS_BASELINE = "2026-06-06"

GOOGLE_HISTORY = [
    (f"data/games-{date}.json", f"data/enrichment-{date}.json", f"data/trends-{date}.json")
    for date in (
        "20260903", "20260902", "20260901", "20260831", "20260828", "20260827", "20260826",
...
def build_google(rows, source_info):
    current = records("data/games-20260903.json", "data/enrichment-20260903.json", "data/trends-20260903.json", "packageName")
    ...
    for row in rows:
        ...
        games.append(game)
    enrichment = deepcopy(load("data/enrichment-20260903.json"))
    enrichment["productCompaniesByRank"] = companies
    save("data/games-20260904.json", games)
    save("data/enrichment-20260904.json", enrichment)
    save("data/trends-20260904.json", trends)
    ...
    save(
        "data/history/google-play/2026-09-04.json",
        {
            "store": "google-play",
            "country": "US",
...
def build_ios(rows, source_url, source_updated):
    current = records("data/ios-games-20260903.json", "data/ios-enrichment-20260903.json", "data/ios-trends-20260903.json", "appId")
    ...
    for row in rows:
        ...
        trends[str(rank)] = analysis
        games.append(game)
    enrichment = deepcopy(load("data/ios-enrichment-20260903.json"))
    enrichment["productCompaniesByRank"] = companies
    save("data/ios-games-20260904.json", games)
    save("data/ios-enrichment-20260904.json", enrichment)
    save("data/ios-trends-20260904.json", trends)
    if bundle:
    ...
    save(
        "data/history/ios/2026-09-04.json",
        {
            "store": "ios",
            "country": "US",
            "device": "iPhone",
