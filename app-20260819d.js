...
const MARKET_BRIEF_PATH = "data/market-brief-20260923.json";
...
const STORE_CONFIGS = {
  googlePlay: {
    ...
    footer: "Google Play US Strategy · TOP60 · Direct capture 2026-09-23",
    method: "直接请求Google Play美国区 GAME_STRATEGY 的 topgrossing 榜单接口，完整校验TOP60；本次直连抓取时间为2026-09-23 09:40:21（北京时间）。AppBrain仅作审计交叉检查（其9月22日榜与直连榜重合59款、同位53款、最大位差1位），未覆盖Google直连结果。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-25 → 2026-09-23。近90天内按Google美国区上架日期进入TOP60的3款产品标为新上榜；较老产品因缺少精确基准快照，暂不判断飙升。",
    games: "data/games-20260923.json",
    enrichment: "data/enrichment-20260923.json",
    trends: "data/trends-20260923.json",
    counterpartGames: "data/ios-games-20260923.json",
  ...
  ios: {
    ...
    footer: "Apple App Store US iPhone Strategy · TOP60 · Updated 2026-09-23",
    method: "Apple App Store 美国区 iPhone Games > Strategy 畅销榜，按Apple官方公开RSS同口径收录TOP60；RSS更新时间为2026-09-22 18:39:13（美国太平洋时间），换算北京时间为9月23日。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-25 → 2026-09-23。近90天内按Apple Lookup上架日期进入TOP60的2款产品标为新上榜；较老产品因缺少精确基准暂不判断飙升。",
    games: "data/ios-games-20260923.json",
    enrichment: "data/ios-enrichment-20260923.json",
    trends: "data/ios-trends-20260923.json",
    counterpartGames: "data/games-20260923.json",
