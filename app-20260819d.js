...
const CACHE_VERSION = "20260925a";
const MARKET_BRIEF_PATH = "data/market-brief-20260925.json";
...
const STORE_CONFIGS = {
  googlePlay: {
    ...
    footer: "Google Play US Strategy · TOP60 · Direct capture 2026-09-25",
    method: "直接请求Google Play美国区 GAME_STRATEGY 的 topgrossing 榜单接口，完整校验TOP60；本次直连抓取时间为2026-09-25 09:27:05（北京时间）。AppBrain仅作审计交叉检查（其9月24日榜与直连榜重合59款、同位21款、最大位差17位），未覆盖Google直连结果。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-27 → 2026-09-25。近90天内按Google美国区上架日期进入TOP60的3款产品标为新上榜；较老产品因缺少精确基准快照，暂不判断飙升。",
    games: "data/games-20260925.json",
    enrichment: "data/enrichment-20260925.json",
    trends: "data/trends-20260925.json",
    counterpartGames: "data/ios-games-20260925.json",
  ...
  ios: {
    ...
    footer: "Apple App Store US iPhone Strategy · TOP60 · Updated 2026-09-25",
    method: "Apple App Store 美国区 iPhone Games > Strategy 畅销榜，按Apple官方公开RSS同口径收录TOP60；RSS更新时间为2026-09-24 18:24:25（美国太平洋时间），换算北京时间为9月25日。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-27 → 2026-09-25。近90天内按Apple Lookup上架日期进入TOP60的3款产品标为新上榜；较老产品因缺少精确基准暂不判断飙升。",
    games: "data/ios-games-20260925.json",
    enrichment: "data/ios-enrichment-20260925.json",
    trends: "data/ios-trends-20260925.json",
    counterpartGames: "data/games-20260925.json",
