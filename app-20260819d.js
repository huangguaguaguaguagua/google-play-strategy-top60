...
const MARKET_BRIEF_PATH = "data/market-brief-20260910.json";
...
const STORE_CONFIGS = {
  googlePlay: {
    ...
    footer: "Google Play US Strategy · TOP60 · Direct capture 2026-09-10",
    method: "直接请求Google Play美国区 GAME_STRATEGY 的 topgrossing 榜单接口，完整校验TOP60；本次直连抓取时间为2026-09-10 09:29:11（北京时间）。AppBrain仅作交叉检查（其9月9日榜与直连榜重合60款、同位55款、最大位差4位），未覆盖直连结果。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-12 → 2026-09-10。近90天内上架且当前进入TOP60的5款产品标为新上榜；较老产品因缺少精确基准快照，暂不判断飙升。",
    games: "data/games-20260910.json",
    enrichment: "data/enrichment-20260910.json",
    trends: "data/trends-20260910.json",
    counterpartGames: "data/ios-games-20260910.json",
  ...
  ios: {
    ...
    footer: "Apple App Store US iPhone Strategy · TOP60 · Updated 2026-09-10",
    method: "Apple App Store 美国区 iPhone Games > Strategy 畅销榜，按Apple官方公开RSS同口径收录TOP60；RSS更新时间为2026-09-09 18:29:18（美国太平洋时间），换算北京时间为9月10日。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-12 → 2026-09-10。近90天内上架且当前进入TOP60的3款产品标为新上榜；iOS精确排名历史从2026-08-19开始积累，较老产品暂不判断飙升。",
    games: "data/ios-games-20260910.json",
    enrichment: "data/ios-enrichment-20260910.json",
    trends: "data/ios-trends-20260910.json",
    counterpartGames: "data/games-20260910.json",
