...
const STORE_CONFIGS = {
  googlePlay: {
    ...
    platform: "Android",
    date: "2026-08-25",
    baselineDate: "2026-05-27",
    eyebrow: "GOOGLE PLAY · ANDROID · STRATEGY · TOP GROSSING",
    title: "Google Play 美国区策略游戏畅销榜 TOP60",
    headerMeta: "每日跟踪 · 美国区 · Android",
    footer: "Google Play US Strategy · TOP60 · Direct capture 2026-08-25",
    method: "直接请求Google Play美国区 GAME_STRATEGY 的 topgrossing 榜单接口，完整校验TOP60；本次直连抓取时间为2026-08-25 09:41:37（北京时间）。AppBrain仍停留在8月24日，仅作交叉检查（重合59款），未覆盖直连结果。",
    baselineCopy: "<strong>状态窗口：</strong>2026-05-27 → 2026-08-25。近90天内上架且当前进入TOP60的5款产品标为新上榜；较老产品因缺少精确基准快照，暂不判断飙升并按常规样式展示。",
    games: "data/games-20260825.json",
    enrichment: "data/enrichment-20260825.json",
    trends: "data/trends-20260825.json",
    counterpartGames: "data/ios-games-20260825.json",
  ...
  ios: {
    ...
    footer: "Apple App Store US iPhone Strategy · TOP60 · Updated 2026-08-25",
    method: "Apple App Store 美国区 iPhone Games > Strategy 畅销榜，按Apple官方公开RSS同口径收录TOP60；RSS更新时间为2026-08-24 18:39:40（美国太平洋时间），换算北京时间为8月25日。",
    baselineCopy: "<strong>状态窗口：</strong>2026-05-27 → 2026-08-25。近90天内上架且当前进入TOP60的4款产品标为新上榜；iOS精确排名历史从2026-08-19开始积累，较老产品暂不判断飙升。",
    games: "data/ios-games-20260825.json",
    enrichment: "data/ios-enrichment-20260825.json",
    trends: "data/ios-trends-20260825.json",
    counterpartGames: "data/games-20260825.json",
