...
const MARKET_BRIEF_PATH = "data/market-brief-20260924.json";
...
const STORE_CONFIGS = {
  googlePlay: {
    ...
    platform: "Android",
    date: "2026-09-24",
    baselineDate: "2026-06-26",
    eyebrow: "GOOGLE PLAY · ANDROID · STRATEGY · TOP GROSSING",
    title: "Google Play 美国区策略游戏畅销榜 TOP60",
    headerMeta: "每日跟踪 · 美国区 · Android",
    footer: "Google Play US Strategy · TOP60 · Direct capture 2026-09-24",
    method: "直接请求Google Play美国区 GAME_STRATEGY 的 topgrossing 榜单接口，完整校验TOP60；本次直连抓取时间为2026-09-24 09:17:45（北京时间）。AppBrain仅作审计交叉检查（其9月23日榜与直连榜重合57款、同位27款、最大位差11位），未覆盖Google直连结果。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-26 → 2026-09-24。近90天内按Google美国区上架日期进入TOP60的2款产品标为新上榜；较老产品因缺少精确基准快照，暂不判断飙升。",
    games: "data/games-20260924.json",
    enrichment: "data/enrichment-20260924.json",
    trends: "data/trends-20260924.json",
    counterpartGames: "data/ios-games-20260924.json",
  ...
  ios: {
    ...
    footer: "Apple App Store US iPhone Strategy · TOP60 · Updated 2026-09-24",
    method: "Apple App Store 美国区 iPhone Games > Strategy 畅销榜，按Apple官方公开RSS同口径收录TOP60；RSS更新时间为2026-09-23 18:12:58（美国太平洋时间），换算北京时间为9月24日。",
    baselineCopy: "<strong>状态窗口：</strong>2026-06-26 → 2026-09-24。近90天内按Apple Lookup上架日期进入TOP60的2款产品标为新上榜；较老产品因缺少精确基准暂不判断飙升。",
    games: "data/ios-games-20260924.json",
    enrichment: "data/ios-enrichment-20260924.json",
    trends: "data/ios-trends-20260924.json",
    counterpartGames: "data/games-20260924.json",
