...
- “Sensor Tower全球收入榜中的策略产品”只从最新一期官方全球手游收入TOP10筛选核心策略产品，展示本地ICON、全球总榜名次、发行商和较上月榜位变化；它不是完整策略品类TOP10
- 单品同比收入百分比在Sensor Tower公开月榜未披露时明确显示“未公开”；页面仅用同月两期官方全市场总额计算约值，不以榜位变化冒充收入涨跌
...
收入月榜在每个工作日检查Sensor Tower官方最新报告；只有官方发布新一期时才更新策略子集的版本化JSON、ICON包与latest文件
